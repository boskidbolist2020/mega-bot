...
@app.route('/mega-bot')
def mega_bot():
    return render_template('mega-bot.html')

@app.route('/mega-bot-send', methods=['POST'])
def mega_bot_send():
    name = request.form['name']
    return render_template('mega-bot.html', text=gpt(name))
